...
public class BankProg {
    ...
    public static void connect() throws SQLException, ClassNotFoundException {
        ...
        c = DriverManager.getConnection ("jdbc:sqlite:C:\\Users\\Admin\\OneDrive\\Документы\\Bank_Account_Manager\\src\\resources\\clients.db");
    }


    public static boolean if_number(String strNum) {
        if (strNum == null) {
            return false;
        }
        try {
    ...
    public static void create_file(Account account, String type, int amount) {
        ...
        if (Objects.equals(choice1, "Yes") || Objects.equals(choice1, "yes")) {
            try {
                ...
                File file = new File("C:\\Users\\Admin\\OneDrive\\Документы\\Bank_Account_Manager\\src\\resources\\" + account.get_client_name() + ".txt");
                ...
                String text = String.format("""
                        ...
                        """, account.account_type(), account.get_client_name());
                switch (type) {
                    case "1" -> {
        ...
        try {
            ...
            switch (choice) {
                ...
                case "5" -> {
                    ...
                    int money = Integer.parseInt(m);
                    int a = account.pay_credit(money);
                    System.out.println(account);
                    if (a == 1) create_file(account, choice, money);
                }
                case "6" -> {
